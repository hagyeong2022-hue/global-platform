  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-2 flex-wrap">
        <span className="inline-block text-xs font-medium text-accent bg-accent-soft px-2 py-0.5 rounded-full">
          {companyName}
        </span>
        <span
        ...
        {score >= 8 && (
          <span className="inline-block text-xs font-medium text-[#FBBF24] bg-[#FBBF24]/15 px-2 py-0.5 rounded-full">
            주요
          </span>
        )}
      </div>
